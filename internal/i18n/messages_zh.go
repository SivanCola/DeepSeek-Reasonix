...
var Chinese = Messages{
	...
	MissingReasoningFallbackFmt:      "模型连续在工具调用中未返回思考内容。Reasonix 已为本会话暂时关闭 thinking 以便工作继续，将在 %s 后自动尝试重新开启。",
	MissingReasoningFallback:         "模型连续在工具调用中未返回思考内容。Reasonix 已在本会话剩余时间内关闭 thinking，以便工作继续。",
	MissingReasoningRecovered:        "模型已恢复返回思考内容，Reasonix 已重新开启 thinking。",
