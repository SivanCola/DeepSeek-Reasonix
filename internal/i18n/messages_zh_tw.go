...
var ChineseTraditional = Messages{
	...
	MissingReasoningFallbackFmt: "模型連續在工具呼叫中未回傳思考內容。Reasonix 已為本會話暫時關閉 thinking 以便工作繼續，將在 %s 後自動嘗試重新開啟。",
	MissingReasoningFallback:    "模型連續在工具呼叫中未回傳思考內容。Reasonix 已在本會話剩餘時間內關閉 thinking，以便工作繼續。",
	MissingReasoningRecovered:   "模型已恢復回傳思考內容，Reasonix 已重新開啟 thinking。",
