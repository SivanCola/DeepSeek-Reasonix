...
var English = Messages{
	...
	SlashHelp:          "commands: /compact · /new · /rewind · /tree · /branch · /switch · /todo · /model (switch model) · /theme · /mcp · /skill · /hooks · /paste-image · /memory · /help · plus skills (/init, /explore, …)",
