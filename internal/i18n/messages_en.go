...
var English = Messages{
	...
	MissingReasoningFallbackFmt: "The model repeatedly returned tool calls without its thinking trace. Reasonix turned thinking off for this conversation so work can continue, and will automatically try re-enabling it in %s.",
	MissingReasoningFallback:    "The model repeatedly returned tool calls without its thinking trace. Reasonix turned thinking off for the rest of this conversation so work can continue.",
	MissingReasoningRecovered:   "The model is returning its thinking trace again. Reasonix turned thinking back on.",
