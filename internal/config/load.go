...
func loadForRoot(root string, migrateOnDisk bool) (*Config, error) {
	...
	globalLegacyAnchorSafetyGate := cfg.Agent.LegacyAnchorSafetyGate
	...
	// The delete_range rollback switch is a user-global operational control;
	// repository-local config must not weaken the workspace safety policy.
	cfg.Agent.LegacyAnchorSafetyGate = globalLegacyAnchorSafetyGate
