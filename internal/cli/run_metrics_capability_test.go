...
func TestMergeCapabilityAuditCopiesNestedCounters(t *testing.T) {
	...
	audit := capability.Audit{
		...
		MCPLists:  capability.MCPListAudit{SharedHost: 4, DiskCache: 1, Remote: 0, DurationMs: 9, ToolCount: 6, SchemaBytes: 128},
	...
	if m.CapabilityMCPLists.SharedHost != 4 || m.CapabilityMCPLists.ToolCount != 6 {
