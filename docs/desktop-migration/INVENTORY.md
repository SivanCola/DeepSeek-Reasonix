...
| `ActivateTopic` | `(scope string, workspaceRoot string, topicID string, sessionPath string) (TabMeta, error)` | desktop/tabs.go:2455 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `CloseTab` | `(tabID string) error` | desktop/tabs.go:3045 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ContextPanel` | `(tabID string) ContextPanelInfo` | desktop/tabs.go:6795 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `CreateTopic` | `(scope string, workspaceRoot string, title string) (TopicMeta, error)` | desktop/tabs.go:6264 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `DeleteTopic` | `(topicID string) error` | desktop/tabs.go:6590 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `EnsureBlankSurface` | `(scope string, workspaceRoot string) (TabMeta, error)` | desktop/tabs.go:2482 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `EnsureBlankTab` | `(scope string, workspaceRoot string) (TabMeta, error)` | desktop/tabs.go:2521 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ListTabs` | `() []TabMeta` | desktop/tabs.go:2183 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `LocateSessionMessageForTab` | `(tabID string, messageID string, snapshot uint64) (session.MessageLocation, error)` | desktop/session_history_service.go:92 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `OpenProjectTab` | `(workspaceRoot string, topicID string) (TabMeta, error)` | desktop/tabs.go:2233 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `OpenTopicSession` | `(scope string, workspaceRoot string, topicID string, sessionPath string) (TabMeta, error)` | desktop/tabs.go:2408 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RenameProject` | `(workspaceRoot string, title string) error` | desktop/tabs.go:6298 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RenameTopic` | `(topicID string, title string) error` | desktop/tabs.go:6408 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ReorderProjects` | `(workspaceRoots []string) error` | desktop/tabs.go:6354 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `ReorderTabs` | `(tabIDs []string) error` | desktop/tabs.go:2989 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SearchSessionHistoryForTab` | `(tabID string, textQuery string, cursor string, limit int) (session.SearchHistoryPage, error)` | desktop/session_history_service.go:84 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SessionHistoryContentForTab` | `(tabID string, ref sessioncontent.Ref, offset int64) (SessionHistoryContentChunk, error)` | desktop/session_history_service.go:102 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SessionHistoryPageForTab` | `(tabID string, cursor string, limit int) (session.MessageHistoryPage, error)` | desktop/session_history_service.go:29 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SessionHistoryWindowForTab` | `(tabID string, req session.HistoryWindowRequest) (session.HistoryWindowPage, error)` | desktop/session_history_service.go:125 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SessionMessageFieldForTab` | `(tabID string, messageID string, version int, field string, offset int64, length int64) (session.MessageFieldPage, error)` | desktop/session_history_service.go:136 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SessionOpenForTab` | `(tabID string) (session.SessionOpenView, error)` | desktop/session_history_service.go:39 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetProjectColor` | `(workspaceRoot string, color string) error` | desktop/tabs.go:6309 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetProjectPinned` | `(workspaceRoot string, pinned bool) error` | desktop/tabs.go:6320 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetTopicPinned` | `(topicID string, pinned bool) error` | desktop/tabs.go:6647 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `session:recovered` |  | desktop/tabs.go:5873 | keep-business (保留业务实现) | `desktop/event frame (seq + generation), same payload` |
