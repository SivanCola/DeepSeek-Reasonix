...
| `AddPermissionRule` | `(list string, rule string) error` | desktop/settings_app.go:2993 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `AddProviderConnection` | `(presetID string, sourceName string, key string) (string, error)` | desktop/settings_app.go:3326 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `AddProviderConnectionWithOptions` | `(presetID string, sourceName string, key string, baseURL string, kind string) (string, error)` | desktop/settings_app.go:3341 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `AddProviderConnectionWithURL` | `(presetID string, sourceName string, key string, baseURL string) (string, error)` | desktop/settings_app.go:3331 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `AddProviderPresetAccess` | `(id string, key string) (string, error)` | desktop/settings_app.go:2653 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ClearBotSecret` | `(envName string) error` | desktop/settings_app.go:3203 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ClearProviderKey` | `(apiKeyEnv string) error` | desktop/settings_app.go:2982 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `FetchAllProviderModelCatalogs` | `(providers []ProviderView) map[string][]ProviderModelCapabilityView` | desktop/settings_app.go:2908 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `FetchAllProviderModels` | `(providers []ProviderView) map[string][]string` | desktop/settings_app.go:2869 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `FetchProviderModelCatalog` | `(p ProviderView) ([]ProviderModelCapabilityView, error)` | desktop/settings_app.go:2814 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `FetchProviderModels` | `(p ProviderView) ([]string, error)` | desktop/settings_app.go:2820 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ReloadSettings` | `() error` | desktop/settings_app.go:3007 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RemovePermissionRule` | `(list string, rule string) error` | desktop/settings_app.go:2998 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `RenameProviderConnections` | `(names []string, displayName string) error` | desktop/settings_app.go:2439 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `ResetProviderPresetAccess` | `(id string) error` | desktop/settings_app.go:2724 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SaveProvider` | `(p ProviderView) error` | desktop/settings_app.go:2459 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SaveProviderKey` | `(apiKeyEnv string, value string) (string, error)` | desktop/settings_app.go:2973 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SaveProviderModelCatalogs` | `(updates []ProviderModelCatalogUpdate) ([]string, error)` | desktop/settings_app.go:2565 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SaveProviderWithKey` | `(p ProviderView, key string) (string, error)` | desktop/settings_app.go:2616 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetAgentParams` | `(temperature float64, maxSteps int, plannerMaxSteps int, systemPrompt string) error` | desktop/settings_app.go:3218 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetBotConnectionToolApprovalMode` | `(connID string, mode string) error` | desktop/settings_app.go:3144 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetBotDingtalkToolApprovalMode` | `(mode string) error` | desktop/settings_app.go:3176 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetBotSecret` | `(envName string, value string) error` | desktop/settings_app.go:3191 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetBotSettings` | `(b BotSettingsView) error` | desktop/settings_app.go:3056 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetCompactRatio` | `(ratio float64) error` | desktop/settings_app.go:3228 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetConnectionKey` | `(name string, value string) (string, error)` | desktop/settings_app.go:3321 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetNetwork` | `(n NetworkView) error` | desktop/settings_app.go:3039 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetPermissionMode` | `(mode string) error` | desktop/settings_app.go:2988 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetProviderKey` | `(apiKeyEnv string, value string) (string, error)` | desktop/settings_app.go:2941 | keep-business (保留业务实现) | hostrpc desktop/invoke |
| `SetProviderWebSearch` | `(names []string, enabled bool) error` | desktop/settings_app.go:2469 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetReasoningLanguage` | `(lang string) error` | desktop/settings_app.go:3235 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `SetSandbox` | `(bash string, network bool, workspaceRoot string, allowWrite []string, shell string) error` | desktop/settings_app.go:3027 | keep-business (保留业务实现) | hostrpc desktop/invoke |
...
| `UpgradeDeepSeekProviderAccess` | `(name string) (string, error)` | desktop/settings_app.go:2637 | keep-business (保留业务实现) | hostrpc desktop/invoke |
