...
mouse, right-click with no selection reads clipboard text through the same paste
path; right-click with a selection copies it. Image paste is application-owned:
