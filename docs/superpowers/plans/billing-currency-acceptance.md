...
- [x] `reasonix doctor billing` surfaces display/billing/FX/catalog
...
4. **Offline / stale FX** — remove or age `~/.reasonix/cache/ecb-fx-cache.json`; custom-currency totals stay incomplete; official dual-region still values via `official_table`.
