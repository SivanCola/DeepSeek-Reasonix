...
// runtime. Shared reasoning-display state, Goal request observability, and the
// native diagnostics privacy copy add small always-available contracts; keep
// the raw allowance tightly ratcheted while gzip stays flat.
