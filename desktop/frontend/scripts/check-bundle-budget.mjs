...
// remaining WKWebView boundary-row race at 451.6 KiB; keep only 0.1 KiB of
// explicit headroom for that invariant.
const initialJSBudgetKiB = process.env.REASONIX_CHANNEL === "test" ? 451.7 : 451.7;
