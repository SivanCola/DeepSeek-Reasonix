...
// measurement invalidation add small always-available contracts. The expanded
// contract remains tightly bounded while the gzip startup budgets stay flat.
assertBudget("initial raw JavaScript and CSS", rawInitialBytes, 2_244 * 1024);
