...
export const zh: Record<DictKey, string> = {
  ...
  "topbar.modelUnavailable": "模型 {model} 已不可用。当前可用模型：{available}",
  "topbar.switchTo": "切换到 {model}",
  "topbar.openModelSettings": "打开模型服务设置",
  "topbar.errorDetails": "详细信息",
  "topbar.noProvidersError": "没有可用模型服务，请先在设置中添加至少一个模型服务并配置 API 密钥。",
  ...
  "settings.modelsProviders": "模型与模型接入",
  "settings.tab.general": "通用",
  "settings.tab.models": "模型",
  "settings.tab.providers": "模型接入",
  ...
  "settings.manageProviders": "管理模型接入",
  "settings.plannerEnabled": "双模型",
  "settings.plannerDisabled": "单模型",
  "settings.providers": "供应商配置",
  ...
  "settings.autoPlan.on": "开启",
      "settings.currentSessionModel": "当前会话模型",
      "settings.modelInvalid": "（不可用）",
      "settings.modelDiffers": "当前会话（{current}）与默认模型（{default}）不一致",
      "settings.modelUnavailable": "模型 {model} 已不可用。",
      "settings.defaultModelUnavailable": "默认模型已不可用。",
      "settings.syncActiveToDefault": "同步当前会话到默认模型",
      "settings.syncAllToDefault": "同步所有会话到默认模型",
  "settings.keySet": "已设密钥",
  "settings.noKey": "无密钥",
  "settings.cantDeleteDefault": "无法删除默认供应商",
  "settings.deleteProvider": "删除供应商",
  "settings.confirmDeleteProvider": "确认删除供应商",
  ...
  "settings.fetchModelsMissingBaseUrl": "请先填写 base_url",
  "settings.fetchModelsMissingKeyEnv": "请先填写 api_key_env 并保存密钥",
  ...
  "settings.balanceUrlHint": "可选。填了就会查询并在状态栏显示钱包余额。",
	  ...
	  "settings.contextWindowPlaceholder": "token 数（0 = 供应商默认值）",
	  "settings.contextWindowHint": "该供应商在上下文中保留的最大 token 数。填 0 表示使用供应商默认值。",
	  ...
	  "settings.supportedEffortsHint": "勾选该供应商在 /effort 命令中暴露的等级，或添加自定义名称。留空则使用内置默认（DeepSeek：high|max，Anthropic：low|medium|high|xhigh|max）。",
