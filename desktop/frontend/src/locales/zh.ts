...
export const zh: Record<DictKey, string> = {
  ...
  "settings.importCCSwitch": "导入 cc-switch",
  "settings.importCCSwitch.short": "cc-switch",
  "settings.importCCSwitch.hint": "把 cc-switch 中已配置的供应商复制到 Reasonix 接入列表。默认保留已有密钥，除非开启覆盖。",
  "settings.importCCSwitch.loading": "正在读取 cc-switch 供应商...",
  "settings.importCCSwitch.empty": "没有找到 cc-switch 供应商。",
  "settings.importCCSwitch.modelCount": "{n} 个模型",
  "settings.importCCSwitch.keyPresent": "已有密钥",
  "settings.importCCSwitch.keyMissing": "缺少密钥",
  "settings.importCCSwitch.replaceKeys": "覆盖已有密钥",
  "settings.importCCSwitch.confirm": "导入选中项",
  "settings.importCCSwitch.status.ready": "可导入",
  "settings.importCCSwitch.status.unsupported": "暂不支持",
  "settings.importCCSwitch.status.invalid": "配置无效",
  "settings.importCCSwitch.status.missingKey": "缺少密钥",
  "settings.importCCSwitch.status.skipped": "已跳过",
