...
export const zh: Record<DictKey, string> = {
  ...
  "settings.closeBehaviorHint": "保持后台运行时，关闭窗口会隐藏应用；可从 Dock 或菜单中显示窗口，也可从菜单退出 Reasonix。",
  "settings.closeBehaviorHintMac": "保持后台运行时，关闭窗口会隐藏应用；可从 Dock 或菜单中显示窗口，也可从菜单退出 Reasonix。",
  "settings.closeBehaviorHintDesktop": "保持后台运行时，关闭窗口会隐藏应用；再次启动 Reasonix 会恢复已有窗口，也可从菜单退出 Reasonix。",
