...
export const zh: Record<DictKey, string> = {
  ...
  "settings.themeScheme": "色彩方案",
  "settings.themeAuto": "自动",
  "settings.themeLight": "浅色",
  "settings.themeDark": "深色",
  "settings.themeMode.auto": "自动",
  "settings.themeMode.light": "浅色",
  "settings.themeMode.dark": "深色",
  "settings.themeScheme.clay": "暖陶",
  "settings.themeScheme.clay.desc": "默认品牌色，适合日常",
  "settings.themeScheme.blue": "专注蓝",
  "settings.themeScheme.blue.desc": "清晰阅读与规划",
  "settings.themeScheme.forest": "森林",
  "settings.themeScheme.forest.desc": "长文阅读和评审",
  "settings.themeScheme.amber": "暮金",
  "settings.themeScheme.amber.desc": "低亮度夜间工作",
  "settings.themeScheme.teal": "终端青",
  "settings.themeScheme.teal.desc": "高区分度密集工作",
  "settings.theme.auto": "自动",
  "settings.theme.auto.desc": "跟随系统浅色或深色",
  "settings.theme.light": "暖白",
  "settings.theme.light.desc": "柔和中性色，适合日常",
  "settings.theme.dark": "陶土深色",
  "settings.theme.dark.desc": "默认低眩光深色",
  "settings.theme.focus": "专注蓝",
  "settings.theme.focus.desc": "清爽阅读与规划",
  "settings.theme.forest": "森林",
  "settings.theme.forest.desc": "长文阅读和评审",
  "settings.theme.midnight": "午夜",
  "settings.theme.midnight.desc": "夜间编码低亮度",
  "settings.theme.contrast": "终端",
  "settings.theme.contrast.desc": "高区分度密集工作",
