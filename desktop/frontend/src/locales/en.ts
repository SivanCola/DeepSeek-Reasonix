...
export const en = {
  ...
  "topbar.modelUnavailable": "{model} is no longer available. Available models: {available}",
  "topbar.switchTo": "Switch to {model}",
  "topbar.openModelSettings": "Open model settings",
  "topbar.errorDetails": "Details",
  "topbar.noProvidersError": "No model providers are configured. Add at least one provider with a valid API key in Settings.",
  ...
  "settings.modelsProviders": "Models & provider access",
  ...
  "settings.manageProviders": "Manage provider access",
  ...
  "settings.providerAccessHint": "Providers appear here only after you add them. Available models follow the provider-returned list.",
  ...
  "settings.plannerNone": "Same as default",
  ...
  "settings.currentSessionModel": "Current session model",
  "settings.modelInvalid": "(unavailable)",
  "settings.modelDiffers": "Current session ({current}) differs from default ({default})",
  "settings.modelUnavailable": "Model {model} is no longer available.",
  "settings.defaultModelUnavailable": "Default model is no longer available.",
  "settings.syncActiveToDefault": "Sync current session to default",
  "settings.syncAllToDefault": "Sync all sessions to default",
  ...
  "settings.fetchModels": "Refresh available models",
  ...
  "settings.fetchModelsMissingBaseUrl": "Enter base_url first",
  "settings.fetchModelsMissingKeyEnv": "Enter api_key_env and save the key first",
  ...
  "settings.confirmClearKey": "Confirm clear",
