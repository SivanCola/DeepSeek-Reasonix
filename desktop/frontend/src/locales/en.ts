...
export const en = {
  ...
  "settings.importCCSwitch": "Import cc-switch",
  "settings.importCCSwitch.short": "cc-switch",
  "settings.importCCSwitch.hint": "Copy configured cc-switch providers into Reasonix provider access. Existing keys are kept unless replacement is enabled.",
  "settings.importCCSwitch.loading": "Loading cc-switch providers...",
  "settings.importCCSwitch.empty": "No cc-switch providers found.",
  "settings.importCCSwitch.modelCount": "{n} models",
  "settings.importCCSwitch.keyPresent": "key present",
  "settings.importCCSwitch.keyMissing": "missing key",
  "settings.importCCSwitch.replaceKeys": "Replace existing keys",
  "settings.importCCSwitch.confirm": "Import selected",
  "settings.importCCSwitch.status.ready": "ready",
  "settings.importCCSwitch.status.unsupported": "unsupported",
  "settings.importCCSwitch.status.invalid": "invalid",
  "settings.importCCSwitch.status.missingKey": "missing key",
  "settings.importCCSwitch.status.skipped": "skipped",
