...
export const en = {
  ...
  "settings.closeBehaviorHint": "When keeping Reasonix running, closing the window hides the app. Use the Dock or menu to show it, or quit Reasonix from the menu.",
  "settings.closeBehaviorHintMac": "When keeping Reasonix running, closing the window hides the app. Use the Dock or menu to show it, or quit Reasonix from the menu.",
  "settings.closeBehaviorHintDesktop": "When keeping Reasonix running, closing the window hides the app. Launch Reasonix again to restore the existing window, or quit Reasonix from the menu.",
