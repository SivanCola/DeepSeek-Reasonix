...
export const en = {
  ...
  "botDetail.close": "Back to chat",
  "botDetail.manage": "Manage settings",
  "botDetail.openSession": "Open local session",
  ...
  "settings.botConnectPhoneTitle": "Connect phone bots",
  "settings.botConnectPhoneSubtitle": "Lightweight QR connection for Feishu, Lark, and WeChat.",
