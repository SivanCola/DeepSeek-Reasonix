...
export const en = {
  ...
  "settings.themeScheme": "Color scheme",
  ...
  "settings.themeScheme.clay": "Warm clay",
  "settings.themeScheme.clay.desc": "Default brand tone for daily work",
  "settings.themeScheme.blue": "Focus blue",
  "settings.themeScheme.blue.desc": "Crisp reading and planning",
  "settings.themeScheme.forest": "Forest",
  "settings.themeScheme.forest.desc": "Calm review and long reading",
  "settings.themeScheme.amber": "Dusk amber",
  "settings.themeScheme.amber.desc": "Low-glare late-night work",
  "settings.themeScheme.teal": "Terminal teal",
  "settings.themeScheme.teal.desc": "High separation dense work",
  "settings.theme.auto": "Auto",
  "settings.theme.auto.desc": "Follow system light or dark",
  "settings.theme.light": "Warm light",
  "settings.theme.light.desc": "Soft neutral daytime work",
  "settings.theme.dark": "Clay dark",
  "settings.theme.dark.desc": "Default low-glare dark",
  "settings.theme.focus": "Focus blue",
  "settings.theme.focus.desc": "Crisp reading and planning",
  "settings.theme.forest": "Forest",
  "settings.theme.forest.desc": "Calm review and long reading",
  "settings.theme.midnight": "Midnight",
  "settings.theme.midnight.desc": "Dim late-night coding",
  "settings.theme.contrast": "Terminal",
  "settings.theme.contrast.desc": "High separation dense work",
