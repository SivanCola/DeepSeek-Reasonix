...
function isCompactionSummary(text: string): boolean {
  ...
  return (
    s.startsWith("<!-- reasonix:compaction -->") ||
    s.startsWith("Summary of earlier conversation") ||
    s.startsWith("Summary of the later conversation")
  );
}

function stripCompactionMarker(text: string): string {
  return text.replace(/^<!-- reasonix:compaction -->\s*/u, "");
}
