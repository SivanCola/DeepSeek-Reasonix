import { APP_VERSION, openUrl, check as checkUpdate, version as getVersion } from "../tauri-compat";
...
export function AboutModal({ onClose }: { onClose: () => void }) {
  ...
  useEffect(() => {
    void getVersion().then(setVersionLabel).catch(() => undefined);
  }, []);
  ...
  const checkForUpdates = useCallback(async () => {
    ...
    try {
      ...
      if (!update) {
        setCheck({ kind: "up-to-date", latest: versionLabel });
      } else {
      ...
      <div className="about-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="about-meta">
          <div className="about-row">
            ...
            <code className="about-value">{versionLabel}</code>
          </div>
          <div className="about-row">
