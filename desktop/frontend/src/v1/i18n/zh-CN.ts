...
export const zhCN: typeof en = {
  ...
  settings: {
    ...
    themeStyleGraphiteDesc: "中性深色底盘，橙色强调。",
    themeStyleEmber: "Ember",
    themeStyleEmberDesc: "中性深色底盘，强化暖橙强调。",
    themeStyleAurora: "Aurora",
    themeStyleAuroraDesc: "中性深色底盘，青绿色强调更柔和。",
    themeStyleSandstone: "Sandstone",
    themeStyleSandstoneDesc: "中性浅色底盘，温暖橙色强调。",
    themeStylePorcelain: "Porcelain",
    themeStylePorcelainDesc: "中性浅色底盘，紫色强调更干净。",
    themeStyleLinen: "Linen",
    themeStyleLinenDesc: "中性浅色底盘，纸张感暖色强调。",
    themeStyleGlacier: "Glacier",
    themeStyleGlacierDesc: "中性浅色底盘，清爽蓝色强调。",
    themeStyleMidnight: "Midnight",
    themeStyleMidnightDesc: "中性深色底盘，紫蓝强调更克制。",
    fontScale: "字体大小",
    ...
    baseUrlHint: "模型服务端点。走代理或兼容服务时再改，留空 = 默认地址。需重启。",
    workspace: "工作目录",
    ...
    commandTitle: "终端命令",
    commandHint: "添加 /usr/local/bin/reasonix，以便在终端里运行 Reasonix。",
    commandHintInstalled: "已安装到 {path}。",
    commandHintUpdate: "更新 {path}，让它指向当前 Reasonix app。",
    commandHintForeign: "已存在非 Reasonix Desktop 安装的 reasonix 命令，不会覆盖。",
    commandHintUnsupported: "此入口仅支持 macOS。",
    commandInstall: "安装",
    commandInstalling: "正在安装...",
    commandInstalled: "已安装",
    commandUpdate: "更新",
    commandExists: "已存在",
    commandUnsupported: "不可用",
    commandInstalledToast: "已安装 reasonix 命令到 {path}",
    commandUpdatedToast: "已更新 reasonix 命令到 {path}",
    editorSystem: "系统默认",
    editorCustom: "自定义",
    editorPlaceholder: '例如 "code"、"subl" 或可执行文件全路径',
    editorDefault: "(默认)",
    apiKey: "API key",
    apiKeyHint: "模型服务 API key — 保存到 ~/.reasonix/config.json (0600)。",
    apiKeyNotSet: "(未设置)",
    apiKeyCancel: "取消",
    apiKeySave: "保存",
    apiKeyShow: "显示",
    ...
    pageAboutLabel: "关于",
    pageAboutDesc: "版本信息与软件更新",
    appearanceSection: "外观",
    editorSection: "编辑器",
    behaviorSection: "行为",
    apiSection: "模型服务",
    aboutSection: "关于 Reasonix",
    updateSection: "软件更新",
    updateIdle: "当前版本：{version}",
    updateNow: "立即更新",
    updateDownload: "前往下载页",
    updateMacHint: "macOS 暂不支持自动更新，请前往下载页手动安装。",
    updateDownloading: "下载中… {done} / {total}（{pct}%）",
    updateVerifying: "正在验证签名…",
    updateApplying: "正在安装…",
    updateDone: "更新完成，正在重启…",
    qqSection: "QQ 通道",
    qqTitle: "QQ机器人集成",
    qqConnected: "已连接",
    qqConnecting: "连接中",
