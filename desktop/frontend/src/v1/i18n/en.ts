export const en = {
  ...
  settings: {
    ...
    themeStyleGraphiteDesc: "Neutral dark shell with an orange accent.",
    themeStyleEmber: "Ember",
    themeStyleEmberDesc: "Neutral dark shell with a warmer orange accent.",
    themeStyleAurora: "Aurora",
    themeStyleAuroraDesc: "Neutral dark shell with a softer teal accent.",
    themeStyleSandstone: "Sandstone",
    themeStyleSandstoneDesc: "Neutral light shell with a warm orange accent.",
    themeStylePorcelain: "Porcelain",
    themeStylePorcelainDesc: "Neutral light shell with a clean violet accent.",
    themeStyleLinen: "Linen",
    themeStyleLinenDesc: "Neutral light shell with a paper-warm accent.",
    themeStyleGlacier: "Glacier",
    themeStyleGlacierDesc: "Neutral light shell with a crisp blue accent.",
    themeStyleMidnight: "Midnight",
    themeStyleMidnightDesc: "Neutral dark shell with a restrained violet-blue accent.",
    ...
    baseUrlHint: "Provider endpoint. Override for proxies or compatible services. Empty = default endpoint. Restart required.",
    workspace: "Workspace",
    workspaceHint:
    ...
    commandTitle: "Terminal command",
    commandHint: "Add /usr/local/bin/reasonix so you can run Reasonix from Terminal.",
    commandHintInstalled: "Installed at {path}.",
    commandHintUpdate: "Update {path} so it points to the current Reasonix app.",
    commandHintForeign: "A reasonix command already exists and was not installed by Reasonix Desktop.",
    commandHintUnsupported: "This action is only available on macOS.",
    commandInstall: "Install",
    commandInstalling: "Installing...",
    commandInstalled: "Installed",
    commandUpdate: "Update",
    commandExists: "Exists",
    commandUnsupported: "Unavailable",
    commandInstalledToast: "Installed reasonix command at {path}",
    commandUpdatedToast: "Updated reasonix command at {path}",
    editorSystem: "System default",
    editorCustom: "custom",
    editorPlaceholder: 'e.g. "code", "subl", or full path to executable',
    editorDefault: "(default)",
    apiKey: "API key",
    apiKeyHint: "Model service API key — saved to ~/.reasonix/config.json (0600).",
    ...
    pageModelsDesc: "Model service, default model & sampling parameters",
    ...
    pageAboutDesc: "Version and software updates",
    // section headers
    appearanceSection: "Appearance",
    editorSection: "Editor",
    behaviorSection: "Behavior",
    apiSection: "Model service",
    aboutSection: "About Reasonix",
    updateSection: "Software update",
    updateIdle: "Current version: {version}",
    updateNow: "Update now",
    updateDownload: "Go to download page",
    updateMacHint: "Automatic update is not available on macOS yet. Download and install manually.",
    updateDownloading: "Downloading... {done} / {total} ({pct}%)",
    updateVerifying: "Verifying signature...",
