...
export const de: typeof en = {
  ...
  settings: {
    ...
    baseUrlHint:
      "Anbieter-Endpunkt. Für Proxys oder kompatible Dienste überschreiben. Leer = Standardendpunkt. Neustart erforderlich.",
    ...
    apiKeyHint: "API-Schlüssel des Modelldienstes — gespeichert in ~/.reasonix/config.json (0600).",
    ...
    pageModelsDesc: "Modelldienst, Standardmodell und Sampling-Parameter",
