...
export const ja: typeof en = {
  ...
  settings: {
    ...
    baseUrl: "API ベースURL",
    baseUrlHint: "プロバイダーのエンドポイント。プロキシや互換サービスで上書き。空欄 = 既定のエンドポイント。再起動が必要です。",
    workspace: "ワークスペース",
    workspaceHint:
    ...
    editorDefault: "(デフォルト)",
    apiKey: "APIキー",
    apiKeyHint: "モデルサービスのAPIキー — ~/.reasonix/config.json (0600) に保存。",
    apiKeyNotSet: "(未設定)",
    apiKeyCancel: "キャンセル",
    apiKeySave: "保存",
    apiKeyShow: "表示",
    ...
    pageModelsLabel: "モデル",
    pageModelsDesc: "モデルサービス、デフォルトモデル、サンプリングパラメータ",
