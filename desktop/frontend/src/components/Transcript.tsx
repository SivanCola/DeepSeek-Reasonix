      ...
      {empty ? (
        ...
        <LiveStreamContext.Provider value={live}>
          <Virtuoso<TranscriptRow, TranscriptVirtuosoContext>
            ...
            itemSize={itemSize}
            minOverscanItemCount={layoutSafeMode || readerBuffering ? { top: 32, bottom: 32 } : { top: VIRTUAL_OVERSCAN_ROWS, bottom: VIRTUAL_OVERSCAN_ROWS }}
            increaseViewportBy={layoutSafeMode || readerBuffering ? { top: (scrollElement?.clientHeight ?? 0) * 2, bottom: (scrollElement?.clientHeight ?? 0) * 2 } : { top: 480, bottom: 480 }}
