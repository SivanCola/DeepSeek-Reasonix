...
export function baseSettings(displayMode: "standard" | "compact" = "standard"): SettingsView {
  return {
    ...
    agent: { temperature: 0, maxSteps: 0, plannerMaxSteps: 0, maxSubagentDepth: 2, maxSubagentConcurrency: 6, maxParallelWriters: 3, systemPrompt: "", coldResumePrune: false, reasoningLanguage: "auto", compactRatio: 0.85 },
    bot: {
      enabled: false,
      model: "",
      toolApprovalMode: "",
