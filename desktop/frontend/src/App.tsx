...
import type { ComposerInsertRequest, Meta, Mode, SessionMeta, TabMeta } from "./lib/types";
...
export default function App() {
  ...
  // "/memory" opens the settings centre on the Memory page. Everything else — skills (/init, …),
