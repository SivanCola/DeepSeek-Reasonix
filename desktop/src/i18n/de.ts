...
export const de: typeof en = {
  ...
  settings: {
    ...
    installReasonixCommand: "reasonix-Befehl installieren",
    installReasonixCommandHint: "/usr/local/bin/reasonix hinzufügen, damit Reasonix im Terminal läuft.",
    installReasonixCommandAction: "Installieren",
    installReasonixCommandInstalling: "Installiere…",
    installReasonixCommandInstalled: "Installiert",
    installReasonixCommandUpdate: "Aktualisieren",
    installReasonixCommandExists: "Vorhanden",
    installReasonixCommandUnsupported: "Nicht verfügbar",
    installReasonixCommandHintInstalled: "Installiert unter /usr/local/bin/reasonix.",
    installReasonixCommandHintUpdate:
      "/usr/local/bin/reasonix aktualisieren, damit es auf die aktuelle Reasonix-App zeigt.",
    installReasonixCommandHintForeign:
      "Ein reasonix-Befehl existiert bereits und wurde nicht von Reasonix Desktop installiert.",
    installReasonixCommandHintUnsupported: "Diese Aktion ist nur unter macOS verfügbar.",
    ...
    pageUpdatesDesc: "Versionsinfo und manuelle Update-Prüfung",
  ...
  app: {
    ...
    update: {
      ...
      alreadyUpToDate: "Reasonix ist aktuell",
      checkFailedToast: "Update-Prüfung fehlgeschlagen: {message}",
    },
    exportUserLabel: "Du",
