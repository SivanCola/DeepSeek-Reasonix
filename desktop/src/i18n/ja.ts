...
export const ja: typeof en = {
  ...
  settings: {
    ...
    checkForUpdatesHint: "起動時の自動確認を待たず、今すぐ手動で確認します。",
    checkForUpdatesAction: "今すぐ確認",
    installReasonixCommand: "reasonix コマンドをインストール",
    installReasonixCommandHint: "/usr/local/bin/reasonix を追加して、ターミナルから Reasonix を実行できるようにします。",
    ...
    installReasonixCommandHintUpdate:
      "/usr/local/bin/reasonix を更新して、現在の Reasonix app を指すようにします。",
    installReasonixCommandHintForeign:
      "reasonix コマンドは既に存在し、Reasonix Desktop がインストールしたものではありません。",
    ...
    pageUpdatesLabel: "更新",
    pageUpdatesDesc: "バージョン情報と手動更新チェック",
  ...
  app: {
    ...
    update: {
      ...
      alreadyUpToDate: "最新バージョンです",
      checkFailedToast: "更新確認に失敗しました: {message}",
    },
    exportUserLabel: "あなた",
