...
export const zhCN: typeof en = {
  ...
  settings: {
    ...
    checkForUpdatesHint: "手动立即检查，不必等待启动时的自动检查。",
    checkForUpdatesAction: "立即检查",
    installReasonixCommand: "安装 reasonix 命令",
    installReasonixCommandHint: "添加 /usr/local/bin/reasonix，以便在终端里运行 Reasonix。",
    installReasonixCommandAction: "安装",
    installReasonixCommandInstalling: "正在安装…",
    installReasonixCommandInstalled: "已安装",
    installReasonixCommandUpdate: "更新",
    installReasonixCommandExists: "已存在",
    installReasonixCommandUnsupported: "不可用",
    installReasonixCommandHintInstalled: "已安装到 /usr/local/bin/reasonix。",
    installReasonixCommandHintUpdate:
      "更新 /usr/local/bin/reasonix，让它指向当前 Reasonix app。",
    installReasonixCommandHintForeign:
      "已存在非 Reasonix Desktop 安装的 reasonix 命令，不会覆盖。",
    installReasonixCommandHintUnsupported: "此入口仅支持 macOS。",
  ...
  app: {
    ...
    update: {
      ...
      checkFailedToast: "检查更新失败：{message}",
    },
    exportUserLabel: "你",
