export const en = {
  ...
  settings: {
    ...
    checkForUpdatesHint: "Manually check now instead of waiting for startup auto-check.",
    checkForUpdatesAction: "Check now",
    installReasonixCommand: "Install reasonix command",
    installReasonixCommandHint: "Add /usr/local/bin/reasonix so you can run Reasonix from Terminal.",
    installReasonixCommandAction: "Install",
    installReasonixCommandInstalling: "Installing...",
    installReasonixCommandInstalled: "Installed",
    installReasonixCommandUpdate: "Update",
    installReasonixCommandExists: "Exists",
    installReasonixCommandUnsupported: "Unavailable",
    installReasonixCommandHintInstalled: "Installed at /usr/local/bin/reasonix.",
    installReasonixCommandHintUpdate:
      "Update /usr/local/bin/reasonix so it points to the current Reasonix app.",
    installReasonixCommandHintForeign:
      "A reasonix command already exists and was not installed by Reasonix Desktop.",
    installReasonixCommandHintUnsupported: "This action is only available on macOS.",
    ...
    pageUpdatesLabel: "Updates",
    pageUpdatesDesc: "Version info and manual update checks",
    ...
    updateSection: "Application updates",
  ...
  app: {
    ...
    update: {
      ...
      alreadyUpToDate: "Reasonix is up to date",
      checkFailedToast: "Update check failed: {message}",
    },
    exportUserLabel: "You",
