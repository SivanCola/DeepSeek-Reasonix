...
var ciJobs = map[string]struct {
	...
	"ci.yml/desktop-windows-go":                   {classKeepBusiness, "aggregate of native Windows desktop Go test groups"},
	"ci.yml/desktop-windows-go-group":             {classKeepBusiness, "native Windows desktop Go suite on independent test-group runners"},
